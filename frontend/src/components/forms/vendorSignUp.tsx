...
export function VendorSignUp({ onSuccess, redirectTo }: UserSignUpProps) {
  ...
  const form = useForm<RegisterVendorValidator>({
  ...
  const handleUserSignUp = async (data: RegisterVendorValidator) => {
    setIsLoading(true);
    setError(null);
    setSuccess(false);
