...
// const handleRental = (data: RentalOrder) => {
//   const res = api.rental.Rental;
// };
                  ...
                  <div className='flex items-center justify-between sm:justify-start sm:space-x-4'>
                    ...
                    <div className='flex border rounded-md'>
                      <Button
                        ...
                        className={`rounded-r-none text-xs sm:text-sm px-2 sm:px-3 ${viewMode === 'card' ? 'bg-orange-500 hover:bg-orange-500' : ''} `}
                      >
                      ...
                      <Button
                        ...
                        className={`rounded-l-none border-l text-xs sm:text-sm px-2 sm:px-3 ${viewMode === 'list' ? 'bg-orange-600 hover:bg-orange-600' : ''}`}
                      >
              ...
              {viewMode === 'list' ? (
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4'>
                  {currentOrders.map((order) => (
                    <Card
                      key={order.id}
                      className='hover:shadow-md hover:shadow-orange-200 transition-shadow'
                      onClick={() => handleRoute(order)}
                    >
